...
see: <s>https://forum.openwrt.org/t/codechef-community-build/69998 to request packages, provide feedback etc.</s> 
...
- https://github.com/abhinavuser/codechef/issues
...
## github-guides
- guides [abhinavuser/codechef/misc/README.md](https://github.com/abhinavuser/codechef/blob/master/misc/README.md)

	- [i am new, hardware, flashing, initial setup](https://github.com/abhinavuser/codechef/blob/master/misc/guides/abc123.md)
	- [updatecheck bar or flavour](https://github.com/abhinavuser/codechef/blob/master/misc/guides/updatecheck.md)
	- [ini-editing](https://github.com/abhinavuser/codechef/blob/master/misc/guides/updatecheck.md#ini-editing)
	- [i have large data](https://github.com/abhinavuser/codechef/blob/master/misc/guides/i_have_large_data.md)
	- [i need something added](https://github.com/abhinavuser/codechef/blob/master/misc/guides/i_need_something_added.md)
	- [o' shit](https://github.com/abhinavuser/codechef/blob/master/misc/guides/fsck.md)
	- [i'm paranoid](https://github.com/abhinavuser/codechef/blob/master/misc/guides/im_paranoid.md)
	- [using vlans](https://github.com/abhinavuser/codechef/blob/master/HARDWARE.md#using-vlans)
	- [dd-backups](https://github.com/abhinavuser/codechef/blob/master/misc/guides/dd-backups.md)
	- [factory-tricks](https://github.com/abhinavuser/codechef/blob/master/misc/guides/factory-tricks.md)
...
- sqmdscp console/other priority @> codechef.qos > REMOVED ~ 2023 ~ in most / all nft based builds (master and 23.05.x)
...
- OLD/MASTERONLY? (may have broken around 2022-03) codechef-official-opkg.sh for security and bugfixes from master (this may not work post around 2022/03)
